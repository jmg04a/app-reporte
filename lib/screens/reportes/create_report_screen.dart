...
// 1. IMPORTACIÓN ACTUALIZADA PARA TENER ACCESO A TODAS LAS VARIABLES DE PLATAFORMA
...
class _CreateReportScreenState extends State<CreateReportScreen> {
  ...
  // 2. NUEVA FUNCIÓN INTELIGENTE PARA DECIDIR QUÉ ABRIR
  void _manejarBotonImagen() {
    if (kIsWeb) {
      // Es Web: Abre el explorador de archivos directo
      _procesarImagen(ImageSource.gallery);
    } else if (defaultTargetPlatform == TargetPlatform.android ||
        defaultTargetPlatform == TargetPlatform.iOS) {
      // Es Celular: Muestra el menú inferior (Cámara / Galería)
      _mostrarOpcionesDeImagen();
    } else {
      // Es PC (Mac/Windows/Linux): Abre el explorador de archivos directo
      _procesarImagen(ImageSource.gallery);
    }
  }
  ...
  Future<void> _enviarReporte() async {
    ...
    try {
      ...
      if (_imagenSeleccionada != null) {
        ...
        evidenciaUrlFinal = supabase.storage
            .from('evidencias')
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            DropdownButtonFormField<int>(
              ...
              items: _categorias.map((cat) {
                return DropdownMenuItem<int>(
                  ...
                  child: Row(
                    children: [
                      Icon(_getIconFromName(cat['icono']),
            ...
            const Text("Ubicación del problema",
            ...
            if (_selectedEdificioId != null)
              DropdownButtonFormField<int>(
                ...
                hint: _aulas.isEmpty
                    ? const Text("Sin aulas específicas")
            ...
            InkWell(
              // 3. SE CONECTA EL BOTÓN A LA FUNCIÓN INTELIGENTE
