...
class _ResultadosBusquedaScreenState extends State<ResultadosBusquedaScreen> {
  ...
  Future<void> _cargarResultados() async {
    ...
    if (_bloqueoRecarga) return; // Validación del candado
  ...
  Widget build(BuildContext context) {
    ...
    return CallbackShortcuts(
      bindings: {
        SingleActivator(LogicalKeyboardKey.keyR, control: !isApple, meta: isApple,includeRepeats: false): _cargarResultados,
      ...
      child: Focus(
        ...
        autofocus: true, // SOLUCIÓN APLICADA AQUÍ
        child: Scaffold(
          appBar: AppBar(
